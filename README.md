# VmCreator OpenAPI Specification
[![Build Status](https://travis-ci.org/MehrCurry/openapitest.svg?branch=master)](https://travis-ci.org/MehrCurry/openapitest)
...
6. If you did everything correct, https://mehrcurry.github.io/openapitest/ will lead to your new docs
...
- Documentation(ReDoc): https://mehrcurry.github.io/openapitest/
- SwaggerUI: https://mehrcurry.github.io/openapitest/swagger-ui/
- Look full spec:
    + JSON https://mehrcurry.github.io/openapitest/swagger.json
    + YAML https://mehrcurry.github.io/openapitest/swagger.yaml
- Preview spec version for branch `[branch]`: https://mehrcurry.github.io/openapitest/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://mehrcurry.github.io/openapitest/ with url from the message: `Server started <url>`
